...
declare -r AK_COLOR_Green='\033[0;32m'
declare -r AK_COLOR_BGreen='\033[1;32m'
declare -r AK_COLOR_Red='\033[0;31m'
declare -r AK_COLOR_BRed='\033[1;31m'
declare -r AK_COLOR_Yellow='\033[0;33m'
declare -r AK_COLOR_BYellow='\033[1;33m'

declare -r AK_COLOR_Blue='\033[0;34m'
declare -r AK_COLOR_BBlue='\033[1;34m'
declare -r AK_COLOR_Magenta='\033[0;35m'
declare -r AK_COLOR_BMagenta='\033[1;35m'
declare -r AK_COLOR_Cyan='\033[0;36m'
declare -r AK_COLOR_BCyan='\033[1;36m'
declare -r AK_COLOR_White='\033[0;37m'
declare -r AK_COLOR_BWhite='\033[1;37m'
declare -r AK_COLOR_Gray='\033[0;90m'
declare -r AK_COLOR_BGray='\033[1;90m'

declare -r AK_COLOR_NC='\033[0m' # No Color
